  ...
  return (
    <main className="mx-auto w-full max-w-xl px-4 py-16">
      ...
      <p className="mt-3 text-sm leading-6 text-white/60">
        Paid users mint a 48-hour <span className="text-white">Gift access</span> code
        after checkout or from Signals. Paste it here. Payment Link returns must include{" "}
        <span className="text-white">session_id</span> so we can verify Stripe and show
        Use / Gift / Invite.
      </p>
      {access.ok && (
