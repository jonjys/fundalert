  ...
  return (
    <main className="mx-auto w-full max-w-xl px-4 py-16">
      ...
      <p className="mt-3 text-sm leading-6 text-white/60">
        Actionable funding-carry trade cards. You execute. Tips only — not financial
        advice. No custody, no auto-trade.
        Start Trial (29 SEK / 3 days) and we add <span className="text-white">+3 days</span>{" "}
